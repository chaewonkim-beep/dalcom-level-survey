    ...
    images: [
      {
        ...
        alt:
          '유아 2단계 교재의 ’수의 순서 길 연결하기’ 페이지. 토끼가 출발해 당근까지, 1씩 작아지는 수의 길을 따라 연결하는 활동입니다.',
        label: '유아 2단계',
      },
    ],
    options: [
    ...
    images: [
      {
        ...
        alt:
          '유아 2단계 교재의 ’수직선에서 작은 수 연산하기’ 페이지. 수 카드 7과 2, 더하기 기호 카드를 놓고 수직선 위에서 연산해 보는 활동입니다.',
        label: '유아 2단계',
      },
    ],
    options: [
    ...
    images: [
      {
        ...
        alt:
          '유아 2단계 교재의 ’2씩 묶어 세기’ 페이지. 케이크와 롤케이크 그림을 2개씩 묶어 세어 개수를 적고, 짝수인지 홀수인지 알아보는 활동입니다.',
        label: '유아 2단계',
      },
    ],
    options: [
    ...
    images: [
      {
        ...
        alt:
          '유아 1단계 교재의 ’10 만들기’ 페이지. 노란 보석 3개와 분홍 보석 7개로 10을 만들고, 3 더하기 7은 10이라는 식으로 표현한 예시입니다.',
        label: '유아 1단계',
      },
    ],
    options: [
    ...
    images: [
      {
        ...
        alt:
          '유아 2단계 교재의 ’수의 크기 비교하기’ 페이지. 수 카드 23과 28을 놓고 수 막대 카드로 나타내어 어느 쪽이 큰지 기호 카드로 비교하는 활동입니다.',
        label: '유아 2단계',
      },
    ],
    options: [
