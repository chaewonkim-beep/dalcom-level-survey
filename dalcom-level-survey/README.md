...
| 번호 | 문항 | 이미지 |
| --- | --- | --- |
| 5 | 20에서부터 거꾸로 세어 내려가기 | 수의 순서 길 연결하기 (유아2 p7) |
| 6 | 한 자리 수의 연산 | 수직선에서 작은 수 연산하기 (유아2 p21) |
| 7 | 두 개씩 묶어 세기 | 2씩 묶어 세기 (유아2 p82) |
| 8 | 더해서 10이 되는 두 수 | 10 만들기 (유아1 p183) |
| 9 | 수의 크기 비교 | 수의 크기 비교하기 (유아2 p124) |
| 10 | 수를 '양'으로 이해 | 수배열표 (유아1 p161) |

수·연산 6문항은 서술문 + `아직 어려워해요 / 할 수 있어요` 형식입니다.

이미지는 `public/images/` 에 있고 모두 **760 × 636** 으로 같게 잘라 두어
문항끼리 크기가 어긋나지 않습니다. 확대 보기 기능은 넣지 않았습니다.
모바일에서 화면을 벌려 확대하면 충분히 보입니다.
